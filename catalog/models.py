...
class Product(models.Model):
    ...
    in_stock = models.IntegerField(default=0, verbose_name=_("В наличии"))
    is_active = models.BooleanField(default=True, verbose_name=_("Активен"))
    category = models.ForeignKey(Category, null=True, blank=True, on_delete=models.SET_NULL, related_name="products", verbose_name=_("Категория"))
