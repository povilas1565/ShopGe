...
class Lead(models.Model):
    ...
    phone = models.CharField(max_length=50, verbose_name=_("Телефон / Email"))
    source = models.CharField(max_length=50, verbose_name=_("Источник"))
    message = models.TextField(blank=True, null=True, verbose_name=_("Сообщение"))
    created_at = models.DateTimeField(auto_now_add=True)
    processed = models.BooleanField(default=False, verbose_name=_("Обработан"))
